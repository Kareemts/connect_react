...
import ReportedUser from '../reportedUsers/ReportedUsers';
...
export default function Dashboard() {
  ...
  const [blckedPosts, setBlockedPosts] = useState(false);
  const [blckedUsers, setBlockedUsers] = useState(false);
  const [password, setPssword] = useState(false);
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {blckedPosts ? <ReportedPost /> : ''}
        {blckedUsers ? <ReportedUser /> : ''}
